(function () {
  ...
  function buildMailto(email, url, code, companyName){
    ...
    var body = [
      ...
      '',
      '• De Hart voor de Zaak Voordeelshop',
      '  Profiteer van aantrekkelijke aanbiedingen op allerlei producten en leuke uitjes.',
      '',
      '• Het Hartstichting Vitaliteitspakket',
      '  Ontdek praktische informatie en tools om goed voor je hart te zorgen. Van een receptenboekje en wandelmagazine tot een beweegprogramma en kennis over gezonder eten.',
      '',
